...
<html>
	...
	<body>
		...
		<form action="delete_flight_details_form_handler.php" method="post" style="margin-left: 350px;">
			<h2 style="margin-top: 150px">ENTER THE FLIGHT SCHEDULE TO BE DELETED</h2>
			<div>
			<?php
			...
			?>
			<table cellpadding="5" style="padding-left: 150px;">
				<tr>
